    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isSelected ? AppColors.cF9A405 : AppColors.cE0E5EC),
        ),
        child: CustomText(
          text: label,
          style: TextStyle(color: isSelected ? AppColors.white : AppColors.c61677D, fontWeight: FontWeight.w600, fontSize: 14),
        ),
      ),
    );
  }
