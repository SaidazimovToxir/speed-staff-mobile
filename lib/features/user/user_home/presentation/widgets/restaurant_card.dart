...
class RestaurantCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => context.push('${RouteNames.restaurantDetail}/${restaurant.id}'),
      child: Container(
              ...
              children: [
                ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Icon(Icons.restaurant, color: AppColors.cE0E5EC, size: 48)), // Placeholder for actual image
                  ),
                ),
                Positioned(
                  top: 12,
                ...
                if (restaurant.id == 'r1') // Mocking TOP RATED tag for specific item
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: AppColors.cF9A405, borderRadius: BorderRadius.circular(16)),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: AppColors.cF9A405.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8)),
                        child: Row(
                          children: [
                            ...
                            CustomText(
                              ...
                              style: const TextStyle(color: AppColors.cF9A405, fontWeight: FontWeight.bold, fontSize: 12),
                            ),
                          ],
                        ),
                      ),
                      ...
                      Row(
                        children: [
                          Container(
                            width: 8,
                            height: 8,
                            decoration: BoxDecoration(color: restaurant.isOpen ? Colors.green : Colors.red, shape: BoxShape.circle),
                          ),
                          8.g,
                          CustomText(
                            text: restaurant.isOpen ? "Open Now" : "Closes at 10:00 PM",
                            style: TextStyle(
                          ...
                          if (restaurant.id == 'r1') ...[
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(color: AppColors.cF6F6F6, borderRadius: BorderRadius.circular(4)),
                              child: Row(
                                children: [
                                  ...
                                  CustomText(
                                    text: "<50",
                                    style: const TextStyle(fontSize: 10, color: AppColors.c61677D),
                                  ),
                                ],
                              ),
                            ),
