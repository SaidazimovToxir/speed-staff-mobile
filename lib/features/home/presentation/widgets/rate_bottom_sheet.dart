    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          8.g,
          Text(
            _rating == 5 ? "Excellent" : _rating == 4 ? "Great" : _rating == 3 ? "Good" : "Poor",
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: const TextStyle(color: AppColors.c61677D),
              filled: true,
              fillColor: AppColors.white,
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
                borderSide: const BorderSide(color: AppColors.cE0E5EC),
              ),
