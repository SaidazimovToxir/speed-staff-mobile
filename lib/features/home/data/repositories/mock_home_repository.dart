import 'package:speed_staff_mobile/features/home/domain/models/restaurant_model.dart';
...
class MockHomeRepository {
  ...
  static final List<Restaurant> restaurants = [
    Restaurant(
      ...
      isFavorite: false,
      isOpen: true,
      imageUrl: 'assets/images/placeholder_restaurant_1.png', 
    ...
    Restaurant(
      ...
      isFavorite: true,
      isOpen: true,
      imageUrl: 'assets/images/placeholder_restaurant_2.png',
    ...
    Restaurant(
      ...
      isFavorite: false,
      isOpen: false,
      imageUrl: 'assets/images/placeholder_restaurant_3.png',
